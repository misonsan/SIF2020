 ...
 getAuthHeader(): HttpHeaders   {
   ...
   getTabelle() {
     ...
     // la chiamata la faccio solo se ho il token per abilitare la lettura solo a uteti loggati
       ...
       deleteTabella(tabellatw: Tabellatw) {
         return this.http.delete(this.APIURL + '/' + tabellatw.id,  {
           headers: this.getAuthHeader()
         });      // ok;
   ...
   updateTabella(tabellatw: Tabellatw) {
     ...
     tabellatw['_method'] = 'PUT';
 
     return this.http.patch(this.APIURL + '/' + tabellatw.id, tabellatw,  {
       headers: this.getAuthHeader()
     });      // ok;
    ...
    createTabella(tabellatw: Tabellatw){
     return this.http.post(this.APIURL, tabellatw,  {
       headers: this.getAuthHeader()
     });      // ok;
   }
